...
$router->post('/deleteaccount', 'V1\Common\User\UserAuthController@deleteaccount');
...
$router->group(['middleware' => 'auth:user'], function($app) {
    ...
    $app->post('/address/updatedefault', 'V1\Common\User\HomeController@updatedefaultaddress');
