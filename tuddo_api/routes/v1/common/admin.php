...
$router->group(['middleware' => 'auth:admin'], function ($app) {
    ...
    $app->delete('/users/{id}', ['uses' => 'V1\Common\Admin\Resource\UserController@destroy']);
    ...
    $app->post('/provider/addamount/{id}', 'V1\Common\Admin\Resource\ProviderController@addamount');
