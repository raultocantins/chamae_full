...
class Notifications extends BaseModel
{
    ...
    public function getExpiryTimeAttribute() {
        return (isset($this->attributes['expiry_date'])) ? (\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $this->attributes['expiry_date'], config('constants.timezone', 'America/Sao_Paulo')))->format('m-d-Y') : '' ;
