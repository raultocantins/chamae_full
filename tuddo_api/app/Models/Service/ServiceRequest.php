...
class ServiceRequest extends BaseModel
{
   ...
   /**
    ...
    /*public function getCreatedAtAttribute() {
        return (isset($this->attributes['created_at'])) ? (\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $this->attributes['created_at'], config('constants.timezone', 'America/Sao_Paulo')))->setTimezone($this->attributes['timezone'])->format('Y-m-d H:i:s') : '' ;
        
    }*/
    public function getAssignedTimeAttribute() {
        return (isset($this->attributes['assigned_at'])) ? (\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $this->attributes['assigned_at'], config('constants.timezone', 'America/Sao_Paulo')))->setTimezone($this->attributes['timezone'])->format(Helper::dateFormat(1)) : '' ;
        
    }

    public function getScheduleTimeAttribute() {
        return (isset($this->attributes['schedule_at'])) ? (\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $this->attributes['schedule_at'], config('constants.timezone', 'America/Sao_Paulo')))->setTimezone($this->attributes['timezone'])->format(Helper::dateFormat(1)) : '' ;
        
    }

    public function getStartedTimeAttribute() {
        return (isset($this->attributes['started_at'])) ? (\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $this->attributes['started_at'], config('constants.timezone', 'America/Sao_Paulo')))->setTimezone($this->attributes['timezone'])->format(Helper::dateFormat(1)) : '' ;
        
    }

    public function getFinishedTimeAttribute() {
        return (isset($this->attributes['finished_at'])) ? (\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $this->attributes['finished_at'], config('constants.timezone', 'America/Sao_Paulo')))->setTimezone($this->attributes['timezone'])->format(Helper::dateFormat(1)) : '' ;
    ...
    public function getCreatedTimeAttribute() {
        return (isset($this->attributes['created_at'])) ? (\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $this->attributes['created_at'], config('constants.timezone', 'America/Sao_Paulo')))->setTimezone($this->attributes['timezone'])->format(Helper::dateFormat()) : '' ;
