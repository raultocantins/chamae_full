    ...
    */
    ...
    public function cancelOrder($request) {
        ...
        try{
            ...
            if(in_array($orderRequest->status, ['SEARCHING', 'ORDERED','STORECANCELLED', 'PROCESSING', 'PROVIDEREJECTED'])) {
    ...
    public function shopAccept(Request $request) {
        ...
        try {
            ...
            if($request->has('delivery_date')){
                ...
                $delivery_date = (Carbon::createFromFormat('Y-m-d H:i:s', (Carbon::parse($request->delivery_date)->format('Y-m-d H:i:s')), $timezone))->setTimezone(config('constants.timezone', 'America/Sao_Paulo'));
