...
class AdminController extends Controller
{
    ...
    public function StoreAutoAssign()
    {
      try {
        ...
        //\Log::info("Schedule ShopOrder Request Started at ".$cur_date);
    ...
    public function total_orders()
    {
       try{
        ...
        $total_earnings = DB::connection('order')->table('store_order_invoices')->select(DB::raw('sum(total_amount - delivery_amount - commision_amount) as total_amount'))->where('store_id',Auth::guard('shop')->user()->id)->where('company_id',Auth::guard('shop')->user()->company_id)->where('status',1);
