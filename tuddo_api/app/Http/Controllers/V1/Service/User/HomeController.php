...
public function gettripdetails(Request $request,$id) {
	...
	public function get_service_request_dispute(Request $request,$id) {
		...
		$service_request_dispute->created_time=(\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $service_request_dispute->created_at, config('constants.timezone', 'America/Sao_Paulo')))->setTimezone($service_request_dispute->request->timezone)->format(Helper::dateFormat());
		} 						
