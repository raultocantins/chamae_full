    ...
    public function servicePricePost(Request $request)
    {
        // dd($request->all());
         $this->validate($request, [
            ...
            'fleet_commission' => 'required|nullable|numeric',
            'tax' => 'numeric',
        ...
        try{
            if($request->service_price_id !=''){
                $servicePrice = ServiceCityPrice::where([['service_id', $request->service_id], ['country_id', $request->country_id], ['city_id', $request->city_id]])->first();
