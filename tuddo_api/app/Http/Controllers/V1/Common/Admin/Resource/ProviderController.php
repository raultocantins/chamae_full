   ...
   /**
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            $provider->state_id = $City->state_id;
    ...
    public function zoneStatus(Request $request, $id)
    {
        ...
        try {
            ...
            $Admin = Admin::where([['country_id', $Provider->country_id], ['city_id', $Provider->city_id], ['company_id', $Provider->company_id], ['zone_id', $request->zone_id]])->first();
