...
class PeakHourController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            $PeakHour->start_time = (Carbon::createFromFormat('H:i:s', (Carbon::parse($request->start_time)->format('H:i:s')), $timezone))->setTimezone(config('constants.timezone', 'America/Sao_Paulo'));  
            $PeakHour->end_time = (Carbon::createFromFormat('H:i:s', (Carbon::parse($request->end_time)->format('H:i:s')), $timezone))->setTimezone(config('constants.timezone', 'America/Sao_Paulo'));
