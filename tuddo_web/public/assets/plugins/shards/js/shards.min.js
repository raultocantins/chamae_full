! function(i) {
        ...
        k.prototype = {
            ...
            _fill_yearsView: function(t, e, i, a, s, n, r) {
                for (var o, l, h, d = "", c = i / 10, u = this.picker.find(t), p = Math.floor(a / i) * i, f = p + 9 * c, g = Math.floor(this.viewDate.getFullYear() / c) * c, m = _.map(this.dates, function(t) {
                    ...
                    }), v = p - c; v <= f + c; v += c) o = [e], l = null, v === p - c ? o.push("old") : v === f + c && o.push("new"), -1 !== _.inArray(v, m) && o.push("active"), (v < s || n < v) && o.push("disabled"), v === g && o.push("focused"), r !== _.noop && ((h = r(new Date(v, 0, 1))) === M ? h = {} : "boolean" == typeof h ? h = {
                    enabled: h
                } : "string" == typeof h && (h = {
                    classes: h
            ...
            E = {
                ...
                parseDate: function(t, e, i, s) {
                    ...
                    if (t in d && (t = d[t]), /^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/i.test(t)) {
                        for (a = t.match(/([\-+]\d+)([dmwy])/gi), t = new Date, o = 0; o < a.length; o++) n = a[o].match(/([\-+]\d+)([dmwy])/i), r = Number(n[1]), l = h[n[2].toLowerCase()], t = k.prototype[l](t, r);
    ...
    jQuery && "undefined" != typeof jQuery && (jQuery.fn.customSlider = function(e) {
        var i = "";
        if (void 0 === e) throw new Error("object." + i);
        if ([{
                prop: "start",
                example: "start: [25, 70]"
            }, {
    ...
    s = [], void 0 === (n = "function" == typeof(a = function() {
        ...
        function l(t, e, i) {
            ...
            for (s.length && "object" == typeof s[0][0] ? s.sort(function(t, e) {
                    ...
                    return t[0] - e[0]
                }), a = 0; a < s.length; a++) n(s[a][1], s[a][0], this);
        ...
        function V(t, c, n) {
            var l, h, o, r, d, e, u, s, p = window.navigator.pointerEnabled ? {
                    start: "pointerdown",
                    move: "pointermove",
                    end: "pointerup"
            ...
            function A(t) {
                var e, i, a, s, n, r, o = 100 * (t - (e = l, i = c.ort, a = e.getBoundingClientRect(), s = e.ownerDocument, n = s.documentElement, r = st(s), /webkit.*Chrome.*Mobile/i.test(navigator.userAgent) && (r.x = 0), i ? a.top + r.y - n.clientTop : a.left + r.x - n.clientLeft)) / N();
