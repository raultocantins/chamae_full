        ...
        "columns": [
            ...
            { "data": function (data, type, row) {
                ...
                var button='<div class="input-group-btn action_group"> <li class="action_icon"> <button type="button"class="btn btn-info btn-block "data-toggle="dropdown"><i class="fa fa-ellipsis-v" aria-hidden="true" title="View"></i></button>'+
                        ...
                        button +='<li><a href="javascript:;" data-id="'+data.id+'" data-country_id="'+data.country_id+'" class="dropdown-item edit"><i class="fa fa-edit"></i> Edit</a> </li><li><a href="javascript:;" data-id="'+data.country_id+'" class="dropdown-item bankform"><i class="fa fa-address-card"></i>&nbsp;{{ __('admin.bank_form')}}</a> </li>';
                        button +='</ul> </li></div>';
                        return  button;
            }
