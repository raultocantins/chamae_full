		...
		$change_content = $file;
			...
			if(!$request->has('daily_target'))
			{
                ...
                if(!$request->has('machine')) {
					$search_text = "'machine' => '1'";
					$value_text =  "'machine' => '0'";
					$change_content=str_replace($search_text, $value_text, $change_content);
				}
				...
				if(($request->has('cash')==0 && $request->has('card')==0 && $request->has('machine')==0) && $request->has('payumoney')==0 && $request->has('paypal')==0 && $request->has('paypal_adaptive')==0 && $request->has('braintree')==0 && $request->has('paytm')==0){
