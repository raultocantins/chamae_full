            ...
            <form class="validateForm" files="true">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control decimal" id="offer_min_amount" name="offer_min_amount"
                            placeholder="{{ __('store.admin.shops.minamount') }}">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control decimal" id="offer_percent" name="offer_percent"
                            placeholder="{{ __('store.admin.shops.offper') }}">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6" id="estdeltime">
                        ...
                        <input type="number" class="form-control" id="estimated_delivery_time"
                            name="estimated_delivery_time" placeholder="{{ __('store.admin.shops.estdeltime') }}">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="country_id" id="country_id" class="form-control">
                            ...
                            @foreach (Helper::getCountryList() as $key => $country)
                                <option value={{ $key }}
                                    data-currency={{ Helper::getCountryCurrency($key) }}>{{ $country }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group col-md-6">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control phone" id="contact_number" name="contact_number"
                            placeholder="{{ __('store.admin.shops.contactno') }}">
                    </div>
                    <div class="form-group col-md-6">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="password">{{ __('store.admin.shops.password') }}</label>
                        <input type="password" class="form-control" id="password" name="password"
                            placeholder="{{ __('store.admin.shops.password') }}">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="store_zipcode">{{ __('store.admin.shops.pincode') }}</label>
                        <input type="number" class="form-control" id="store_zipcode" name="store_zipcode"
                            placeholder="{{ __('store.admin.shops.pincode') }}">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="password">{{ __('store.admin.shops.confirmpassword') }}</label>
                        <input type="password" class="form-control" id="confirmpassword"
                            placeholder="{{ __('store.admin.shops.confirmpassword') }}">
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control decimal" id="store_packing_charges"
                            name="store_packing_charges" placeholder="{{ __('store.admin.shops.packing_charges') }}">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="delivery_charge_minkm">{{ __('admin.setting.delivery_charge_minkm') }}</label>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <select name="status" class="form-control">
                            ...
                            <option value="0">{{ __('Onboarding') }}</option>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="image-placeholder w-100" style="margin-left: 10px;">
                ...
                @foreach ($Days as $dky => $day)
                    <div
                        class="row @if ($dky == 'ALL') everyday "  @else  singleday " style="display:none" @endif ">
                        <div class="col-xs-4">
                            <div class="form-group">
                                <label for="hours_opening">{{ __('store.admin.shops.' . $day) }}</label>
                                <input type="checkbox" class="chk form-control {{ $dky }}"
                                    @if ($dky == 'ALL') checked @endif name="day[{{ $dky }}]"
                                    value="{{ $dky }}" data-placement="top" data-autoclose="true">
                            </div>
                        </div>
                        <div class="col-xs-4">
                            <div class="form-group" style="margin-left: 10px;">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control time-picker open_{{ $dky }}"
                                        name="hours_opening[{{ $dky }}]" value="00:00" data-placement="top"
                                        data-autoclose="true" required>
                        ...
                        <div class="col-xs-4">
                            <div class="form-group">
                                ...
                                <div class="input-group ">
                                    <input type="text" class="form-control time-picker close_{{ $dky }}"
                                        name="hours_closing[{{ $dky }}]" value="00:00" data-placement="top"
                                        data-autoclose="true" required>
                                    <span class="input-group-addon">
                                        <i class="fa fa-clock-o"></i>
                                    </span>
                ...
                <button type="submit" class="btn btn-accent ">{{ $action_text }} {{ __('Shop') }}</button>
    ...
    $(document).ready(function() {
        ...
        $('#country_id').on('change', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    var data = parseData(response);
                    $("#city_id").empty();
                    $("#city_id").append('<option>{{ __('Select') }}</option>');
                    $.each(data.responseData, function(key, item) {
                        $("#city_id").append('<option value="' + item.city.id +
                            '">' + item.city.city_name + '</option>');
                    });
        ...
        function loadstorecategory() {
            ...
            if (store_type == "OTHERS") {
                ...
                $("#packing_charges").html(
                    "{{ __('store.admin.shops.shipping_charges') }} (<span id='currency_country'>$</span>)"
                    );
                ...
                $("#packing_charges").html(
                    "{{ __('store.admin.shops.packing_charges') }} (<span id='currency_country'>$</span>)"
                    );
            }
        }
